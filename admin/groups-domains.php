        ...
        <div class="box" id="domains-list">
            <div class="box-header with-border">
                ...
                <div class="filter_types">
                    <div class="line">
                        <span><input type="checkbox" name="typ" value="0" id="typ0"><label for="typ0">Exact whitelist</label></span>
                        <span><input type="checkbox" name="typ" value="2" id="typ2"><label for="typ2">Regex whitelist</label></span>
                    </div>
                    <div class="line">
                        <span><input type="checkbox" name="typ" value="1" id="typ1"><label for="typ1">Exact blacklist</label></span>
                        <span><input type="checkbox" name="typ" value="3" id="typ3"><label for="typ3">Regex blacklist</label></span>
                    </div>
                </div>
            </div>
            <!-- /.box-header -->
